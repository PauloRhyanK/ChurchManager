...
export const SITE_SECTIONS: SiteSectionSpec[] = [
...

  {
    ...
    description: 'Bloco de endereço e horários da sede na home.',
    icon: 'MapPin',
    fields: [
...

  {
    ...
    description: 'Lista de igrejas e campos missionários, com cabeçalho da secção.',
    icon: 'Globe',
    fields: [
      { name: 'badge', label: 'Etiqueta', type: 'text', maxLength: 60 },
      { name: 'titlePart1', label: 'Título — 1.ª linha', type: 'text', maxLength: 120 },
      ...
      { name: 'intro', label: 'Parágrafo de introdução', type: 'textarea', maxLength: LONG_TEXT_MAX },
      {
        ...
        fields: [
          ...
          { name: 'pastor', label: 'Pastor responsável', type: 'text', maxLength: 160 },
          { name: 'image', label: 'Imagem', type: 'image' },
          { name: 'mapsUrl', label: 'Link do Google Maps', type: 'url' },
          {
            name: 'isHeadquarters',
            label: 'É a sede',
            type: 'boolean',
...

  {
    key: 'pastors',
    title: 'Time Pastoral',
    description: 'Pastores listados na página /time-pastoral.',
    icon: 'HandHeart',
    fields: [
      { name: 'badge', label: 'Etiqueta', type: 'text', maxLength: 60 },
      { name: 'titlePart1', label: 'Título — 1.ª linha', type: 'text', maxLength: 120 },
      ...
      { name: 'intro', label: 'Parágrafo de introdução', type: 'textarea', maxLength: LONG_TEXT_MAX },
      {
        ...
        fields: [
          { name: 'name', label: 'Nome', type: 'text', required: true, maxLength: 160 },
          { name: 'role', label: 'Função', type: 'text', maxLength: 160 },
          { name: 'location', label: 'Cidade', type: 'text', maxLength: 160 },
          { name: 'image', label: 'Foto', type: 'image' },
          {
            ...
            type: 'text',
            maxLength: 160,
            help: 'Deve corresponder ao nome usado na secção Igrejas & Missões.',
          },
          { name: 'active', label: 'Visível no site', type: 'boolean' },
        ],
      },
